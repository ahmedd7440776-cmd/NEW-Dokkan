...
//             <div className="relative w-full max-w-md bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-3xl p-6 shadow-2xl transition-colors duration-300 z-10">
//                 <div className="flex items-center justify-between pb-4 border-b border-gray-100 dark:border-gray-800">
//                     <div className="flex items-center gap-2">
//                         <User className="w-5 h-5 text-green-700 dark:text-green-500" />
//                         <h3 className="font-bold text-gray-900 dark:text-white">تسجيل الدخول</h3>
//                     </div>
//                     <button
//                         type="button"
//                         onClick={onClose}
//                         className="p-1.5 text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 transition cursor-pointer"
//                     >
//                         <X className="w-5 h-5" />
//                     </button>
//                 </div>
...
//                             className="w-full bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 rounded-xl p-3 text-sm focus:outline-none focus:ring-2 focus:ring-green-500/20 focus:border-green-500 transition"
//                             required
//                         />
//                     </div>
...
//                     <button
//                         type="submit"
//                         className="w-full py-3 bg-green-800 dark:bg-green-600 hover:bg-green-900 dark:hover:bg-green-500 text-white font-bold text-sm rounded-xl transition shadow-md cursor-pointer"
//                     >
//                         دخول
//                     </button>
//                 </form>
